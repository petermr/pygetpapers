...
def main():
    ...
    try:
        ...
        if not output_data["paper_directories"]:
            ...
            print("   pygetpapers --query 'climate change AND adaptation' --api europe_pmc --limit 10 -x -p --fulltext_html --datatables")
            return
...
<body>
    ...
    <div class="table-section">
        ...
        print(f"   The tables show which papers have the highest hits for climate change terms.")
