...
def add_new_repository_example():
    ...
    new_repository_config = {
        ...
        "api_client": {
            ...
            "headers": {"User-Agent": "pygetpapers/1.0", "Accept": "application/json"},
            "rate_limit": 20,
            "timeout": 30,
        },
        # Response Structure
        ...
        "xml2html_converters": [],
        # Rate Limiting
        "rate_limits": {"requests_per_minute": 20, "delay_between_requests": 3.0},
        # Security
        "security": {
...
def show_existing_repositories():
    ...
    try:
        ...
        print(
            "repo = create_repository('crossref')  # or 'europe_pmc', 'biorxiv', etc."
        )
        print("")
