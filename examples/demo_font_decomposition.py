...
from pygetpapers.core.hocr_builder import (
    HOCRBuilder, decompose_font_name, create_hocr_from_pdfplumber_data
)
...
def demo_hocr_with_font_decomposition():
    ...
    builder.add_word_with_font_name("Bold", 50, 50, 80, 70, font_name="Arial-Bold", font_size=12)
    builder.add_word_with_font_name("Italic", 85, 50, 120, 70, font_name="Times-Italic", font_size=12)
    builder.add_word_with_font_name("BoldItalic", 125, 50, 180, 70, font_name="Helvetica-BoldItalic", font_size=12)
    
    line2 = builder.add_line()
    builder.add_word_with_font_name("Normal", 50, 80, 100, 100, font_name="Arial", font_size=12)
    builder.add_word_with_font_name("Foo-B", 105, 80, 135, 100, font_name="Foo-B", font_size=12)
    builder.add_word_with_font_name("Bar-I", 140, 80, 160, 100, font_name="Bar-I", font_size=12)
...
def demo_pdfplumber_integration():
    ...
    for word in words:
        print(f"'{word.text}': {word.font_family} {word.font_weight} {word.font_style} ({word.font_size}pt)")
