...
class HOCRBuilder:
    ...
    def add_word(self, text: str, x0: float, y0: float, x1: float, y1: float,
                 confidence: float = 1.0, font_family: Optional[str] = None,
                 font_size: Optional[float] = None, font_weight: Optional[str] = None,
                 font_style: Optional[str] = None, color: Optional[str] = None,
                 baseline: Optional[float] = None) -> HOCRWord:
        """
    ...
    def add_word_with_font_name(self, text: str, x0: float, y0: float, x1: float, y1: float,
                               confidence: float = 1.0, font_name: Optional[str] = None,
    ...
    def add_character(self, text: str, x0: float, y0: float, x1: float, y1: float,
                     confidence: float = 1.0, font_family: Optional[str] = None,
                     font_size: Optional[float] = None, font_weight: Optional[str] = None,
                     font_style: Optional[str] = None, color: Optional[str] = None,
                     baseline: Optional[float] = None) -> HOCRCharacter:
        """
    ...
    def add_image(self, x0: float, y0: float, x1: float, y1: float,
                  image_data: Optional[bytes] = None, image_path: Optional[str] = None,
                  alt_text: Optional[str] = None, confidence: float = 1.0) -> Dict[str, Any]:
        """
    ...
    def add_graphic(self, graphic_type: str, x0: float, y0: float, x1: float, y1: float,
                    svg_data: Optional[str] = None, confidence: float = 1.0) -> Dict[str, Any]:
        """
    ...
    def _update_text_content(self):
        ...
        if self.current_line:
            self.current_line.text = " ".join(word.text for word in self.current_line.words)
        
        # Update paragraph text
        if self.current_paragraph:
            self.current_paragraph.text = " ".join(line.text for line in self.current_paragraph.lines)
    ...
    def _add_page_to_hocr_xml(self, parent: ET._Element, page: HOCRPage):
        ...
        page_div = ET.SubElement(parent, "div", {
            "class": "pdf_page",
    ...
    def _add_paragraph_to_hocr_xml(self, parent: ET._Element, paragraph: HOCRParagraph):
        ...
        par_div = ET.SubElement(parent, "div", {
            "class": "pdf_par",
            "id": f"p{self.id_counter}"
        })
        self.id_counter += 1
    ...
    def _add_line_to_hocr_xml(self, parent: ET._Element, line: HOCRLine):
        ...
        line_span = ET.SubElement(parent, "span", {
            "class": "pdf_line",
            "id": f"p{self.id_counter}",
    ...
    def _add_word_to_hocr_xml(self, parent: ET._Element, word: HOCRWord):
        ...
        if word.font_family:
            style_parts.append(f'font-family: "{convert_html_entities(word.font_family)}"')
        if word.font_size:
            style_parts.append(f'font-size: {round_coordinates(word.font_size)}pt')
        if word.font_weight:
            style_parts.append(f'font-weight: {convert_html_entities(word.font_weight)}')
        if word.font_style:
    ...
    def _add_image_to_hocr_xml(self, parent: ET._Element, image: Dict[str, Any]):
        ...
        img_div = ET.SubElement(parent, "div", {
            "class": "pdf_image",
            "id": f"p{self.id_counter}",
    ...
    def _add_graphic_to_hocr_xml(self, parent: ET._Element, graphic: Dict[str, Any]):
        ...
        graphic_div = ET.SubElement(parent, "div", {
            "class": "pdf_graphic",
            "id": f"p{self.id_counter}",
