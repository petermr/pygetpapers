# Redalyc Repository - Ignored Fields

**Date:** July 27, 2025  
**Purpose:** Document fields that should be ignored in Redalyc repository processing  
**Repository:** redalyc
...
### `selenium_session_id` (if present)
- **Source**: Selenium web scraping session
...
### Code Locations
- Primary web scraping processing in `redalyc_selenium.py`
- Selenium session handling logic
