...
class TestUPSpaceMetadata(unittest.TestCase):
    ...
    def test_abstract_extraction(self):
        ...
        for article in articles:
            ...
            if abstract:
                ...
                self.assertGreater(len(abstract), 10)  # Abstract should be reasonably long
    ...
    def test_metadata_completeness(self):
        ...
        optional_fields = ["authors", "abstract", "year", "publisher", "keywords", "sdg_classifications"]
        ...
        for article in articles:
            ...
            present_optional_fields = sum(1 for field in optional_fields if article.get(field))
            self.assertGreater(present_optional_fields, 0, "Article should have at least some optional metadata")
    ...
    def test_metadata_consistency(self):
        ...
        for article in articles[1:]:
            ...
            self.assertGreater(len(common_fields), 5)  # Should have at least 5 common fields
