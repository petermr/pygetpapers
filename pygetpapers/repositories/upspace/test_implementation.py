...
def test_upspace_implementation():
    ...
    try:
        ...
        if articles:
            ...
            articles = upspace.search_articles("", max_results)  # Empty query should return recent articles
            print(f"  Found {len(articles)} articles with empty query (recent articles)")
