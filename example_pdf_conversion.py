...
def example_download_and_convert():
    ...
    try:
        pdf_path, html_path = converter.download_and_convert(url, "Downloaded Research Paper")
...
def example_batch_processing():
    ...
    if pdf_dir.exists():
        ...
        print("Directory 'pdfs' not found. Create it and add PDF files for batch processing.")
