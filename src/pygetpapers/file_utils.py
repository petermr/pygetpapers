...
class FileUtils:
    ...
    @staticmethod
    def write_json_data(data: Dict[str, Any], file_path: Union[str, Path], 
    ...
    @staticmethod
    def write_xml_data(data: Dict[str, Any], file_path: Union[str, Path], 
                      encoding: str = 'utf-8', root_name: str = 'metadata') -> bool:
        """
    ...
    @staticmethod
    def write_html_content(content: str, file_path: Union[str, Path], 
    ...
    @staticmethod
    def generate_article_id(metadata: Dict[str, Any], url: str = "", 
                           prefix: str = "") -> str:
        """
    ...
    @staticmethod
    def read_json_data(file_path: Union[str, Path], encoding: str = 'utf-8') -> Optional[Dict[str, Any]]:
        """
