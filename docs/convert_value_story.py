#!/usr/bin/env python3
"""
Convert UPSpace Value Story presentation to PowerPoint format.
"""
...
def main():
    ...
    # File paths
    markdown_file = Path(__file__).parent / "upspace-value-story.md"
    output_file = Path(__file__).parent / "UPSpace_Value_Story_Presentation.pptx"
    
    print("=" * 60)
    print("Converting UPSpace Value Story to PowerPoint")
    print("=" * 60)
