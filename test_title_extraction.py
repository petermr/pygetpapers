...
def test_title_extraction():
    ...
    for i, part in enumerate(text_parts):
        ...
        keywords_ok = any(keyword in part.upper() for keyword in ['LIPPIA', 'LANTANA', 'VERBENACEAE', 'NOMENCLATURALES'])
        ...
        if (length_ok and keywords_ok and not_redalyc and not_sistema and not_info and not_cientifica and longer):
            best_title = part
