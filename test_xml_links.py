    ...
    for url in test_urls:
        ...
        try:
            ...
            for link in all_links:
                ...
                elif any(keyword in href for keyword in ['download', 'descargar', 'articulo.oa']):
                ...
                elif any(keyword in href for keyword in ['epub', 'mobi', 'txt', 'doc', 'rtf']):
                    other_links.append({
                        'href': full_href,
                        'text': link.get_text(strip=True),
                        'title': link.get('title', '')
            ...
            xml_indicators = [
                'xml', 'jats', 'nlm', 'article-xml', 'fulltext-xml',
                'download xml', 'descargar xml', 'xml format'
            ]
