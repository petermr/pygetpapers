...
from pygetpapers.repositories.biorxiv.biorxiv_web_scraper import BioRxivWebScraper
...
def test_basic_search():
    ...
    results = scraper.search_papers(query=query, max_results=5, results_per_page=10)
...
def test_pagination():
    ...
    if "error" not in results:
        ...
        if pagination["has_next"]:
            ...
            # Parse the next page
            next_results = scraper.search_papers(
                query, max_results=10, results_per_page=10
            )
...
def test_paper_download():
    ...
    if "error" not in results and results["papers"]:
        ...
        print("✅ Testing download for paper:")
...
def test_paper_details():
    ...
    if details:
        print("✅ Paper details extracted successfully!")
