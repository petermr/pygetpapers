...
class TestHOCRBuilderComprehensive(unittest.TestCase):
    ...
    def test_hocr_xml_generation(self):
        ...
        self.assertIn(
            '<meta name="pdf-system" content="pygetpapers hOCR Builder"', hocr_xml
        )
    ...
    def test_image_and_graphic_handling(self):
        ...
        image = builder.add_image(
            x0=300, y0=100, x1=500, y1=200, alt_text="Sample chart", confidence=0.9
        )
    ...
    def test_character_level_details(self):
        ...
        char1 = builder.add_character(
            "T", 50, 50, 60, 70, 0.98, "Arial", 12, "bold", "normal", "#000000", 65
        )
        char2 = builder.add_character(
            "e", 60, 50, 70, 70, 0.96, "Arial", 12, "bold", "normal", "#000000", 65
        )
        char3 = builder.add_character(
            "s", 70, 50, 75, 70, 0.97, "Arial", 12, "bold", "normal", "#000000", 65
        )
        char4 = builder.add_character(
            "t", 75, 50, 80, 70, 0.95, "Arial", 12, "bold", "normal", "#000000", 65
        )
...
def create_hocr_from_tesseract_data(tesseract_data: Dict) -> HOCRBuilder:
    ...
    for page_data in tesseract_data["pages"]:
        page = builder.add_page(
            page_data["page_number"], page_data["width"], page_data["height"]
        )
